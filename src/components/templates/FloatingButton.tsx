...
export function FloatingButton() {
  ...
  return (
    <div
      className="fixed border-[1px] border-[rgba(255,255,255,0.15)] xs:bottom-[20px] md:bottom-[40px]
        xs:right-[20px] md:right-[40px] flex bg-background-secondary rounded-full px-[13px] z-10
        xs:h-[56px] md:h-[68px] items-center justify-center cursor-pointer group"
      onClick={handleClick}
    >
      <ChatTeardropDots
        className="xs:w-7 xs:h-7 md:w-10 md:h-10"
        color="#08ca08"
      />
