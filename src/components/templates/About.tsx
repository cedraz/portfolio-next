    ...
    <section className="bg-background-secondary" id="about">
      <div className="grid mx-auto max-w-7xl px-6 py-8 lg:gap-8 xl:gap-0 lg:py-20 lg:grid-cols-12">
        <div className="col-span-12 place-self-center">
          <Title withMargin={true}>{t('h1')}</Title>
        </div>
        <div
          className="hidden lg:mt-0 lg:col-span-6 align-self-center lg:flex max-w-[500px] h-fit"
          data-aos="fade-right"
        >
          <Image src={AboutImage} alt="contact-me" />
        </div>
        <div
          className="lg:justify-self-end place-self-center col-span-12 lg:col-span-6"
          data-aos="fade-left"
        >
          <AboutCard />
        </div>
