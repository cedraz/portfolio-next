      ...
      <CardContent className="p-6">
        <div className="flex flex-col gap-6">
          <ul className="flex flex-wrap justify-center xl:justify-between gap-2">
            <li className="flex flex-col items-center xs:w-full sm:w-fit  justify-center gap-2 rounded-lg border-white border py-5 px-9">
              <Check size={24} />
              <h2 className="font-bold">{t('card.li1.h2')}</h2>
              <p className="text-gray-400">{t('card.li1.p')}</p>
            </li>
            <li className="flex flex-col items-center xs:w-full sm:w-fit  justify-center gap-1 rounded-lg border-white border py-5 px-9">
              <Check size={24} />
          ...
          <p className="text-justify">{t('card.p')}</p>
        </div>
      </CardContent>
      <CardFooter>
        <Button className="w-full" asChild>
          <Link target="_blank" href={`/curriculumns/${pdfPath}`}>
            {t('card.button')}
          </Link>
        </Button>
      </CardFooter>
